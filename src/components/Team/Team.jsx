  ...
  return (
    <div id="team" className=" w-screen  pt-12 bg-white flex items-center flex-col">
        ...
        <div className="w-screen pl-8[20%]] pt-[20px] pb-[20px] flex flex-wrap justify-center ">
            <TeamCard img={AnuragVerma} name="Anurag Verma" role="Organizer" linkedInUrl="https://www.linkedin.com/in/anuragver/" twitterUrl="https://twitter.com/anuragceg`" color="#4C86F9"/>
            <TeamCard img={BarkhaAgarwal} name="Barkha Agarwal" role="Co-Organizer" linkedInUrl="" twitterUrl="" color="#4C86F9"/>
        </div>
        <h1 className="text-black text-center mt-3 mb-5 text-5xl font-bold">Tech Team</h1>
        <div className="w-screen pl-8[20%]] pt-[20px] pb-[20px] flex flex-wrap justify-center ">
            <TeamCard img={AbhimanyuYadav} name="Abhimanyu Yadav" role="Technical Lead" linkedInUrl="" twitterUrl="" color="#49A84C"/>
            <TeamCard img={BobbyKumar} name="Bobby Kumar" role="Technical Co-Lead" linkedInUrl="" twitterUrl="" color="#49A84C"/>
            <TeamCard img={VishhwajeetKumar} name="Vishwajeet Kumar" role="Tech Team" linkedInUrl="" twitterUrl="" color="#49A84C"/>
        </div>
        <h1 className="text-black text-center mt-3 mb-5 text-5xl font-bold">Operation Team</h1>
        <div className="w-screen pl-8[20%]] pt-[20px] pb-[20px] flex flex-wrap justify-center ">
            <TeamCard img={HarshKapoor} name="Harsh Kapoor" role="Operation Lead" linkedInUrl="" twitterUrl="" color="#F6BA04"/>
            <TeamCard img={AmikarAnanya} name="Amikar Ananya" role="Operation Co-Lead" linkedInUrl="" twitterUrl="" color="#F6BA04"/>
            <TeamCard img={TanyaGupta} name="Tanya Gupta" role="Operation Team" linkedInUrl="" twitterUrl="" color="#F6BA04"/>
            <TeamCard img={MohammadZaidKhan} name="Mohammad Zaid Khan" role="Operation Team" linkedInUrl="" twitterUrl="" color="#F6BA04"/>
            <TeamCard img={AshishKumar} name="Ashish Kumar" role="Operation Team" linkedInUrl="" twitterUrl="" color="#F6BA04"/>
        </div>
        <h1 className="text-black text-center mt-3 mb-5 text-5xl font-bold">Design Team</h1>
        <div className="w-screen pl-8[20%]] pt-[20px] pb-[20px] flex flex-wrap justify-center ">
            <TeamCard img={AsifEkhlaque} name="AsifEkhlaque" role="Design Lead" linkedInUrl="" twitterUrl="" color="#E1432E"/>
            <TeamCard img={Sakshi} name="Sakhshi" role="Design Team" linkedInUrl="" twitterUrl=""color="#E1432E"/>
            <TeamCard img={NishantKumar} name="NishantKumar" role="Design Team" linkedInUrl="" twitterUrl="" color="#E1432E"/>
            <TeamCard img={KhushbooGupta} name="Khushboo Gupta" role="Design Team" linkedInUrl="" twitterUrl="" color="#E1432E" />
        </div>
    </div>
  )
}
