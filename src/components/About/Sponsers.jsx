...
function SponsersCard(props) {
  return (
        <a href={props.link} target="_blank" className="ml-4 mr-4 mt-3 mb-3 p-[3px] box-border shadow-[5px, 5px 5px] shadow-black w-[300px] aspect-video bg-[#F9AA00] border-2 border-[black] rounded-lg flex justify-center shadow-[10 10px 10 10px #8723895]"
        style = {{
