  ...
  return (
      <div className="ml-8 mt-3 mb-3 p-[3px] box-border shadow-[5px, 5px 5px] shadow-black h-[400px] w-[310px] aspect-video bg-[#F9AA00] border-2 border-[black] rounded-lg flex flex-col justify-between	items-start	" 
        style = {{
          ...
          <div className="w-[300px] h-[300px] bg-white border-2 border-[black] rounded-lg flex justify-center items-center	">
              <img 
              src={props.logo} 
              alt="" 
          ...
          <div className="w-[300px] h-[80px]">
              <ul className="h-[100%] w-[100%] flex justify-evenly items-center" >
                <li className="h-[60px] w-[60px] bg-white p-1 rounded-full" ><a  href=""><img className='text-white' src={WebsiteLogo} alt="hey" /></a></li>
                <li className="h-[60px] w-[60px] bg-white p-1 rounded-full"  ><a href=""><img src={LinkedinLogo} alt="hey" /></a></li>
                <li className="h-[60px] w-[60px] bg-white p-1 rounded-full"  ><a href=""><img src={TwitterLogo} alt="hey" /></a></li>
              </ul>
          </div>
      </div>
  )
